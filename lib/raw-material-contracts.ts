import type { ContractAllocationSummary } from "@/lib/material-contract-allocations";
...
export type RawMaterialContract = {
  ...
  created_by: string; created_at: string; updated_by: string | null; updated_at: string; allocation_summary: ContractAllocationSummary;
};
