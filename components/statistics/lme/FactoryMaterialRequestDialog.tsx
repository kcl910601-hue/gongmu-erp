...
import { FACTORY_MATERIAL_REQUEST_DESTINATIONS } from "@/lib/factory-material-request";
import { toast } from "@/lib/toast";

export function FactoryMaterialRequestDialog({ open, onClose, onSaved }: { open: boolean; onClose: () => void; onSaved: () => Promise<void> }) {
  const [form, setForm] = useState({ destinationName: FACTORY_MATERIAL_REQUEST_DESTINATIONS[0], quantityKg: "", usageDate: new Date().toISOString().slice(0, 10), purchaseOrderNo: "", memo: "" });
