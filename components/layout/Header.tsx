...
export default function Header({ onSearchClick, readOnly = false }: HeaderProps) {
  ...
  return (
    <>
      <header className="relative z-40 border-b border-slate-200 bg-white/80 px-5 py-2 backdrop-blur">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 text-slate-600 transition-colors hover:bg-white focus:outline-none focus:ring-2 focus:ring-blue-100"
            >
              <Plus size={18} />
            </button>
            <button
            ...
            <button
              ...
              className="flex h-8 items-center gap-1.5 rounded-lg border border-slate-200 bg-slate-50 px-2.5 text-sm font-medium text-slate-600 transition-colors hover:bg-white focus:outline-none focus:ring-2 focus:ring-blue-100"
            >
