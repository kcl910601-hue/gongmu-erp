...
const emptyOrderStatus: ProjectMaterialOrderStatus = { requestedTons: 0, plannedTons: 0, confirmedTons: 0, allocatedTons: 0, unallocatedTons: 0, excessTons: 0, allocationRate: 0 };
